...
Magewire Tips:
1. This example uses default.xml to add the component of all pages.
2. If you need magewire component on specific page then you must add it in layout xml of that page (required).
3. If you don't add magewire in layout then it won't work.
